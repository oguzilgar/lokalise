class WelcomePage {
  static is_welcome_page_displayed_successfully() {
    cy.contains(`Where do you work, `).should(`be.exist`).should(`be.visible`);
    cy.task(`log`, `Where do you work, text is displayed`);

    cy.contains(`Name of your company`).should(`be.exist`).should(`be.visible`);
    cy.task(`log`, `Name of your company, text is displayed`);

    cy.contains(`Size of your company`).should(`be.exist`).should(`be.visible`);
    cy.task(`log`, `Size of your company text is displayed`);

    cy.contains(`Continue`).should(`be.exist`).should(`be.visible`);
    cy.task(`log`, `Continue button is displayed`);
  }

  static type_name_of_company(userCompanyName) {
    cy.get(`input[placeholder='Name of your company...']`)
      .clear()
      .type(`${userCompanyName}`);
  ...
  static is_welcome_page_displayed_with_three_more_questions_successfully() {
    ...
    cy.contains(` Back`).should(`be.exist`).should(`be.visible`);
  ...
  static is_welcome_page_displayed_with_two_more_questions_successfully() {
    ...
    cy.contains(`2 questions left`).should(`be.exist`).should(`be.visible`);
  ...
  static is_welcome_page_displayed_with_last_question_successfully() {
    ...
    cy.contains(`Last question`).should(`be.exist`).should(`be.visible`);
